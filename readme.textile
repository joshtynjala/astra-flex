...
Please note: I have no long-term plans for maintaining or adding the Astra Flex components beyond making the existing code work in Flex 4. If you have feature requests or need a bug fixed, you may [[Create an Issue|http://github.com/joshtynjala/astra-flex/issues]] or vote on an existing one, but I cannot guarantee that I will be able to respond promptly. Contributors are welcome.